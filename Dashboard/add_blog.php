...
<div class="main-dashboard">
    ...
    <form method="post">
        ...
        if (isset($_POST["btn"]))
        {
            ...
            $sql="INSERT INTO `blog`(`btitle`,scode, `bimg`, `bcontent`, `bdescription`, `major`, `date`, `brate`, `status`)
        VALUES ('$title','$scode','$img','$content','$descrip','$group','$date','$rate',0)";
        ...
        <br>
        <div class="col-12">
            <textarea class="col-9 col-lg-9" style="width: 90%" name="content">مقاله</textarea>
        </div>
        <script>
