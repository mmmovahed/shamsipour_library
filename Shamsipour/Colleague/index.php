...
<div class="main-dashboard">
    <div class="alert alert-primary">
        <b>به پنل همکاری خوش آمدید</b>


    <br>
    <br>
        <?php
        $sql = "SELECT nid,ntitle FROM notification WHERE (nstatus=1 || nstatus=5 || (nstatus=6 && reciver=$scode)) ORDER BY nid DESC";
    ...
    <div class="row">
        ...
        <div class="col-11 col-lg-6 box-dashboard">
            <h4 class="usual_title">کتاب های تازه اضافه شده</h4>
            <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while ($i<=4) {
                    $row = $result->fetch_assoc();
                    $i++;
                    echo "<p>$row[bname] -- $row[bauther]</p>";
                }
            } else {
                echo "<p>لاگی موجود نمیباشد</p>";
            }
        ...
        <div class="box-dashboard col-11 col-lg-4">
            ...
            <div class="row">
                <?php
                $sql = "SELECT * FROM student WHERE status=3 && scode !=$scode";
                $result = $conn->query($sql);
...
<?php
                    ...
                    echo "<p>همکار دیگری موجود نمیباشد</p>";
                }
                ?>
            </div>
        </div>
    ...
    VALUES ('$_POST[title]', '$_POST[description]', '$scode','$_POST[scode]','$date',6)";
                ...
                <form method="post" action="">
                    <input name="scode" class="input-notif" type="text" placeholder="شماره دانشجویی">
                    <br>
                    <br>
