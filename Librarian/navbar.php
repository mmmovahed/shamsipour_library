...
?>
    ...
    <div class="col-12 user-menu">
        <ul>
            ...
            <li><a href="users.php"><i class="fa fa-user icon-menu-admin"></i><span class="title-menu-admin close-element"> کاربران</span></span></a></li>
            ...
            <li><a href="blogs.php"><i class="fa-solid fa-file icon-menu-admin"></i><span class="title-menu-admin close-element"> بلاگ ها</span></span></a></li>
            <li><a href="reserve.php"><i class="fa fa-calendar-check icon-menu-admin"></i><span class="title-menu-admin close-element"> رزرو ها</span></span></a></li>
            <li><a href="news.php"><i class="fa fa-newspaper icon-menu-admin"></i><span class="title-menu-admin close-element"> اخبار</span></span></a></li>
            ...
            <li><a href="tickets.php"><i class="fa fa-ticket icon-menu-admin"></i><span class="title-menu-admin close-element">تیکت ها</span></a></li>
            <li><a href="logs.php"><i class="fa fa-note-sticky icon-menu-admin"></i><span class="title-menu-admin close-element"> لاگ ها</span></span></a></li>
            <li><a href="asks.php"><i class="fa fa-question icon-menu-admin"></i><span class="title-menu-admin close-element"> درخواست ها</span></span></a></li>
            <li><a href="notifs.php"><i class="fa fa-message icon-menu-admin"></i><span class="title-menu-admin close-element">اعلان ها</span></span></a></li>
