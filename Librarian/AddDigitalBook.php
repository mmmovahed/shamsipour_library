...
,'$group','$major','$price','$lang',$rate,1)";
            ...
            if ($conn->query($sql) === TRUE) {
                insertLOG("$_COOKIE[usercode]","$bname","اضافه کردن کتاب دیجیتال");
...
<br><br>
    <textarea style="height: 100px;" placeholder="لینک دانلود" class="col-11 col-lg-5" name="download"></textarea>
    <textarea style="height: 100px;" placeholder="رمز فایل در صورت وجود" class="col-11 col-lg-5" name="pass"></textarea>
    <textarea style="height: 100px;" placeholder="توضیحات" dir="rtl" class="col-11 col-lg-12" name="descrip"></textarea>
    <script>
